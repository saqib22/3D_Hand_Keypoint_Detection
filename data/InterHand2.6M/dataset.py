...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, transform, mode, annot_subset):
        ...
        # self.filenames = open("test_files.txt", "w+")
        # self.bbs = open("bboxs.txt", "w+")
        ...
        for aid in db.anns.keys():
            ...
            if (self.mode == 'val' or self.mode == 'test') and cfg.trans_test == 'rootnet':
                ...
                # test_image = cv2.rectangle(test_image, (bbox[0], bbox[1]), ((bbox[0]+bbox[2]), (bbox[0] + bbox[3])), (255,0,0), 3)
                # cv2.imwrite(str(image_id) + ".jpg", test_image)
                # print(img_path)
                # print(bbox.shape)
                # print(bbox)
    ...
    def evaluate(self, preds):
        ...
        for n in range(sample_num):
            ...
            if vis:
                ...
                vis_valid = [1.0]*21 + [1.0]*21
                vis_3d_keypoints(pred_joint_coord_img, vis_valid, self.skeleton, filename)
